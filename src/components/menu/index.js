...
const CustomLink = ({ href, onClick, children }) => {
    ...
    const size = window.innerWidth > 500 ? '20px' : '16px';
    return (
        <a
            onClick={onClick}
            style={{
...
const title = (
    <div>
        <h1 style={{ fontStyle: 'initial' }}>Incómoda</h1>
        <h2 style={{ padding: 0, margin: 0, fontWeight: 700, fontSize: 20 }}>Cuerpos Libres</h2>
        <hr />
    </div>
);
